...
CUSTOM_NUM_LIST     : LPAREN (INTEGER | DOUBLE','*WS*)+ RPAREN;
CUSTOM_STRING_LIST  : LPAREN (PHRASE','*WS*)+ RPAREN'i'?;
GT                  : '>' ;
GE                  : '>=' ;
LT                  : '<' ;
LE                  : '<=' ;
...
SQUOTE              : '\'';
DQUOTE              : '"';
PHRASE              : SQUOTE (ESC_CHAR|~('\''|'\\'))+ SQUOTE'i'*;
QUOTE               : DQUOTE (ESC_CHAR|~('"'|'\\'))+ DQUOTE'i'*;
